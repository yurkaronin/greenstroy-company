...
function init() {
	...
	var items = [
		...
		new ymaps.Placemark([44.985632, 38.963619], {
			...
			{
				iconLayout: "default#image",
				iconImageHref: "../img/map/magnit.svg",
				iconImageSize: [35, 35],
				iconImageOffset: [-17.5, -35],
			}),
		// Магнит Косметик
		...
		new ymaps.Placemark([44.997393, 38.940063], {
			...
			{
				iconLayout: "default#image",
				iconImageHref: "../img/map/five.svg",
				iconImageSize: [35, 35],
				iconImageOffset: [-17.5, -35],
			}),
		...
		new ymaps.Placemark([44.980016, 38.936317], {
			...
			{
				iconLayout: "default#image",
				iconImageHref: "../img/map/apteka.svg",
				iconImageSize: [35, 35],
				iconImageOffset: [-17.5, -35],
			}),
